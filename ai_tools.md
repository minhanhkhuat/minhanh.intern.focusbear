...
I experimented with GitHub Copilot (specifically using the GitHub Copilot Chat extension integrated directly into VS Code) and ChatGPT via the web browser to assist with code optimization, text editing, and understanding setup environments.
...
AI assistants are most useful during the scaffolding phase and the troubleshooting phase. They act as an excellent on-demand tutor for clarifying configuration commands, explaining errors, and automating repetitive typing tasks. However, AI works best as an accelerator rather than a replacement for understanding. It is most valuable when the developer guides the context actively and audits the output to ensure it aligns perfectly with the local environment.